...
public enum ErrorType {
    ...
    PASSWORD_ERROR(4200, "Şifreler birbiriyle uyuşmamaktadır", HttpStatus.BAD_REQUEST),
    USERNAME_EXISTS(4300, "Bu kullanıcı zaten kayıtlı", HttpStatus.BAD_REQUEST),
    ...
    NOT_ACTIVATED_ACCOUNT(4600, "Hesap aktif edilmemiştir. Lütfen aktivasyon işlemini gerçekleştiriniz", HttpStatus.BAD_REQUEST),
